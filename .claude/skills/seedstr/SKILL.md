...
**No other files are written. Skill files (SKILL.md, references/heartbeat.md, skill.json) are never cached locally unless the human manually downloads them.**
...
2. Follow the references/heartbeat.md routine at the human-approved interval (default: every 3 minutes)
...
**Supervised/Filtered mode:** If your human enabled periodic checking during setup, follow the references/heartbeat.md routine. Otherwise, still only check on explicit request.
